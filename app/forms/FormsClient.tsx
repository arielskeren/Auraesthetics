  ...
  return (
    <>
      ...
      <Section background="ivory">
        ...
        >
          <div className="bg-sage/30 border-l-4 border-sage p-4 md:p-6 rounded-lg mb-8 md:mb-12">
            ...
            {forms.map((form, index) => (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <h3 className="text-lg md:text-h3 font-serif text-charcoal">{form.title}</h3>
                  <span className="px-3 py-1 bg-taupe/30 text-warm-gray text-xs md:text-sm rounded-full">
                    {form.status}
                  </span>
                </div>
                <p className="text-sm md:text-base text-warm-gray leading-relaxed">{form.description}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <Section background="sand">
        ...
        >
          <h2 className="text-2xl md:text-h2 font-serif text-charcoal mb-6 md:mb-8 text-center">
            What to Expect
          </h2>
          
          <div className="space-y-4 md:space-y-6">
            <div className="bg-white p-4 md:p-6 rounded-lg">
              <h3 className="text-base md:text-xl font-serif text-charcoal mb-2 md:mb-3">Before Your Appointment</h3>
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg">
              <h3 className="text-base md:text-xl font-serif text-charcoal mb-2 md:mb-3">For Your First Visit</h3>
              <p className="text-sm md:text-base text-warm-gray">
            ...
            <div className="bg-white p-4 md:p-6 rounded-lg">
              <h3 className="text-base md:text-xl font-serif text-charcoal mb-2 md:mb-3">Digital Signatures</h3>
              <p className="text-sm md:text-base text-warm-gray">
